...
const cacheName = 'A2AbrahamJoseph-2021-02-28 13:24:40.548552'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'A2AbrahamJoseph'.length) === 'A2AbrahamJoseph') {
